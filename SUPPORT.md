...
Hello, thank you for using Astro Component! 🙋🏻‍♂️
...
- Check the [`README`](https://github.com/igorskyflyer/npm-astro-component/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-astro-component/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-astro-component/issues) using the appropriate issue template and with the label of `bug`,
...
- opening a [`new issue`](https://github.com/igorskyflyer/npm-astro-component/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-astro-component/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Astro Component:
...
<div align="center">
  Thank you for using Astro Component!
  <br>
